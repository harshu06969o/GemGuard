/**
 * GeM-Guard API Gateway - Auth Middleware
...
export const MOCK_PERSONAS = {
  'officer@gem.gov.in': {
    ...
    passwords: ['Admin@123', 'admin', 'officer', 'Password@123', 'gemguard'],
  },
  'evaluator@gem.gov.in': {
    id: 'evaluator@gem.gov.in',
...
export function injectProxyHeaders(proxyReq, req) {
  ...
  proxyReq.setHeader('X-Gateway-Service', 'GeM-Guard-API-Gateway');
}
