...
export default function OverrideModal({
  ...
  async function handleSubmit() {
    ...
    setError(null);
    try {
      await submitOfficerAction(String(bidId), {
        action: 'OVERRIDE',
        comment: `Rule ${ruleType} override: ${currentResult} → ${newDecision}. Justification: ${reason.trim()}`,
      });
      onSuccess();
      onClose();
    } catch (e) {
        ...
        <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{
            ...
            <span>
              ...
              timestamp, and SHA-256 chain hash. GeM-Guard does not make procurement decisions —
